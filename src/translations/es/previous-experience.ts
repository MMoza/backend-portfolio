export const previousExperience = {
  ...
  hospitality: {
    ...
    paragraphs: [
      ...
      "Trabajar en hostelería me ayudó a desarrollar disciplina, atención al detalle y una fuerte mentalidad orientada al cliente — habilidades que continúan influenciando cómo abordo el desarrollo de software hoy."
    ]
  },
  ...
  industrial: {
    ...
    paragraphs: [
      ...
      "Durante este período comencé a experimentar con pequeños scripts de automatización y macros de impresora para simplificar tareas de pre-procesamiento y post-procesamiento."
    ]
  },
  ...
  discovering: {
    ...
    paragraphs: [
      "Trabajar de cerca con sistemas de fabricación aditiva me introdujo a G-Code, un lenguaje de comandos utilizado para controlar máquinas CNC e impresoras 3D.",
      "Al aprender cómo estas instrucciones controlaban el comportamiento de la máquina, comencé a experimentar con modificaciones y optimizaciones para mejorar procesos de impresión.",
      "Entender cómo una secuencia de comandos podría controlar una máquina compleja despertó mi curiosidad sobre programación y sistemas de software. Esta experiencia en última instancia me motivó a perseguir formación formal en desarrollo web e iniciar mi transición a la ingeniería de software."
    ]
  },
