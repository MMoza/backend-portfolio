export const previousExperience = {
  ...
  header: {
    ...
    introAfter: ". These experiences shaped my work ethic, problem-solving mindset and ability to adapt to complex operational environments."
  },
  ...
  industrial: {
    title: "Industrial Experience – Additive Manufacturing",
    paragraphs: [
